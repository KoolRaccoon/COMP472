...
output_files = ["n_gram_models/bigramEN.txt", "n_gram_models/bigramFR.txt","n_gram_models/bigramRO.txt"]
...
for i in range (0, len(languages)):
    ...
    for letter in Bigram_list:
        ...
        n_gram_probs[i].append((letter_frequencies[i][incrementor]+1) / (len(train_corpuses[i]))+(1*len(Bigram_list)))
