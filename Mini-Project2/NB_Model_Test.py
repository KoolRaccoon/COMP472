...
# load saved model
NBClassifier_ds1 = joblib.load('Models/NBModelDs1.joblib')

# Predicting the test set
test_predicted_ds1 = NBClassifier_ds1.predict(test_features_ds1)

# print (test_predicted_ds1)
# Saving test predictions 
with open('Results/Test/ds1Test-nb.csv', 'w') as file:
...
# load saved model
NBClassifier_ds2 = joblib.load('Models/DTModelDs2.joblib')

# Predicting the test set
test_predicted_ds2 = NBClassifier_ds2.predict(test_features_ds2)

# print (test_predicted_ds1)
# Saving test predictions 
with open('Results/Test/ds2Test-nb.csv', 'w') as file:
